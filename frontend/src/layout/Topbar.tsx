...
export default function Topbar({ onMenuClick, userLabel }: TopbarProps) {
  ...
  return (
    <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-line-subtle bg-base/70 px-4 backdrop-blur-glass md:px-8">
      <div className="flex items-center gap-3">
        ...
        <div className="hidden items-center gap-2 sm:flex">
          ...
          <span className="text-xs text-ink-muted">
            AI Quality · Sales · Coaching · Risk
          </span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        <div className="hidden text-right md:block">
          ...
          <div className="text-[11px] uppercase tracking-wider text-ink-muted">Operator</div>
        </div>
