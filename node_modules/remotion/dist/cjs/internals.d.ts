...
import type { SequenceFieldSchema, SequenceSchema, VisibleFieldSchema } from './sequence-field-schema.js';
...
export declare const Internals: {
    ...
    readonly createEffect: <P, S>(definition: import("./index.js").EffectDefinition<P, S>) => {} extends P ? (params?: P | undefined) => import("./index.js").EffectDescriptor<unknown> : (params: P) => import("./index.js").EffectDescriptor<unknown>;
